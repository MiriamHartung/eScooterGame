...
{ //MS Motorcycle test - Marcos Schultz (www.schultzgames.com)
    ...
    void FixedUpdate()
    {
        ...
        medRPM = (frontWheel.rpm + rearWheel.
                  rpm) / 2;
    ...
    void Stabilizer()
    {
        ...
        Vector3 torqueForce = axisFromRotate.normalized * axisFromRotate.magnitude * 300;
    ...
    void GenerateWheels()
    {
        ...
        meshCube.transform.localScale = new Vector3(0.5f, 1.0f, 1.0f);
    }
}